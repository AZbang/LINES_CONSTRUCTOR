(function() {
  var RadialNav, animate, describeArc, describeSector, gui, iconsPath, polarToCartesian, random, toggleContext;
  ...
  window.GUI = (function() {
    function GUI(paper, urlIcons, buttons) {
      this.paper = paper;
      Snap.load(urlIcons, (function(_this) {
